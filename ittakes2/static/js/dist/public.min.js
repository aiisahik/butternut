...
"use strict";angular.module("ittakes2.public",["ngResource","ui.bootstrap","ittakes2.services","ittakes2.controllers","ui.router"]).config(["$httpProvider","$resourceProvider","$sceDelegateProvider","$stateProvider","$urlRouterProvider",function(e,r,t,s,o){e.defaults.xsrfCookieName="csrftoken",e.defaults.xsrfHeaderName="X-CSRFToken",r.defaults.stripTrailingSlashes=!1}]);
angular.module("ittakes2.services",[]).factory("DataService",["$q","Profiles","Profile","Matches",function(e,r,o,s){var i={};return i.profiles_defer=e.defer(),i.get_profiles=function(o){return o&&(i.profiles_defer=e.defer()),!i.profiles||o?r.query().$promise.then(function(e){e&&e.objects&&(i.profiles=e.objects),i.profiles_defer.resolve(i.profiles)}):i.profiles_defer.resolve(i.profiles),i.profiles_defer},i.get_matches=function(r){var o=e.defer();return!i.matches||r?i.profiles_defer.promise.then(function(e){var r={};_.each(e,function(e){r[e.user_id]=e}),console.log("profiles dict",r),s.query().$promise.then(function(e){if(e&&e.objects){var s=e.objects;_.each(s,function(e){e.winner=r[e.winner_id],e.loser=r[e.loser_id]}),i.matches=s}o.resolve(i.matches)})}):o.resolve(i.matches),o},i}]);
"use strict";angular.module("ittakes2.services").factory("Profiles",["$resource",function(r){return r("/api/v1/profile/",{},{query:{isArray:!1,method:"GET"}})}]).factory("Profile",["$resource",function(r){return r("/api/v1/profile/:id",{},{query:{isArray:!1,method:"GET"},update:{isArray:!1,method:"PUT"},create:{isArray:!1,method:"POST"},remove:{isArray:!1,method:"DELETE"}})}]).factory("Matches",["$resource",function(r){return r("/api/v1/match/",{},{query:{isArray:!1,method:"GET"},create:{isArray:!1,method:"POST"}})}]).factory("MatchCalculator",["$resource",function(r){return r("/calc/",{},{post:{isArray:!1,method:"POST"}})}]);
angular.module("ittakes2.controllers",[]).controller("homeController",["$scope","DataService",function(n,o){o.get_profiles()}]).controller("rankingsController",["$scope","DataService","MatchCalculator",function(n,o,e){var i=this;i.loading=!1,i.init=function(){i.loading=!0,o.profiles_defer.promise.then(function(n){i.loading=!1,i.profiles=n})},i.calc=function(){i.loading=!0,e.post({calc:"all"}).$promise.then(function(n){n.success?o.get_profiles(!0).promise.then(function(n){i.loading=!1,i.profiles=n}):i.loading=!1})},i.init()}]).controller("matchesController",["$scope","DataService","MatchCalculator",function(n,o,e){var i=this;i.loading=!1,i.init=function(){i.loading=!0,o.get_matches().promise.then(function(n){i.loading=!1,i.matches=n,console.log(i.matches)})},i.init()}]).controller("newMatchController",["$scope","DataService","Matches",function(n,o,e){var i=this;i.loading=!1,i.winner_profiles=[],i.loser_profiles=[],i.form_data={winner_score:21},i.init=function(){i.loading=!0,o.profiles_defer.promise.then(function(n){i.loading=!1;var o=n;i.winner_profiles=angular.copy(o),i.loser_profiles=angular.copy(o)})},i.update_profiles=function(){i.form_data.loser&&(i.winner_profiles=_.filter(i.winner_profiles,function(n){return n.user_id!==i.form_data.loser.user_id})),i.form_data.winner&&(i.loser_profiles=_.filter(i.loser_profiles,function(n){return n.user_id!==i.form_data.winner.user_id}))},i.reset=function(){i.new_match=null,i.form_data={winner_score:21}},i.submit=function(n){n.$valid&&(i.loading=!0,e.create(i.form_data).$promise.then(function(n){i.loading=!1,i.new_match=n}))},i.init()}]);